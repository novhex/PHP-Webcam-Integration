...
var shutter_tone_url ='http://localhost/webcamphp/assets/shutter.mp3';
var swf_file_url = 'http://localhost/webcamphp/assets/webcam.swf';
...
window.webcam = {
	...
	swf_url: swf_file_url, // URI to webcam.swf movie (defaults to cwd)
	shutter_url: shutter_tone_url, // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : shutter_tone_url;
	},
